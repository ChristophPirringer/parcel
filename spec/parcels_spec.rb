...
describe(Parcel) do
  ...
  describe("#volume") do
    it("returns 25 for the volume of a 5 inch cubic package") do
      test_parcel = Parcel.new(5, 5, 5, 10, 10, "regular_delivery", "no_gift")
  ...
  describe("#cost_to_ship") do
    ...
    it("returns 250 for the cost to ship a 5 inch cubic package of 10 lb for 10 miles and fast delivery") do
      test_parcel = Parcel.new(5, 5, 5, 10, 10, "fast_delivery", "super_gift")
      expect(test_parcel.cost_to_ship()).to(eq(550))
    end
  end
